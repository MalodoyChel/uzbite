...
import { COMPANY, SERVICES_LIST, NAV_LINKS } from "../../data/constants";
                  ...
                  <div className="grid grid-cols-3 gap-5 ">
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="text-sm text-slate-600">
                        We provide comprehensive digital solutions including web development, mobile app creation, custom software, cloud services, UI/UX design, and digital marketing to help your business thrive.
                      </p>
                      <div className="grid grid-cols-3 ">
                        <ul className="mt-3 flex flex-col gap-2">
                          ...
                          <li className="cursor-pointer text-black/80 hover:text-primary">
                            <a href="#ios-dev">IOS App Development</a>
                          </li>
                          <li className="cursor-pointer text-black/80 hover:text-primary">
                            <a href="#android-dev">Android Development</a>
                          </li>
                        </ul>
                        <ul className="mt-3 flex flex-col gap-2">
                          <h1 className="pb-1 text-xl font-semibold">
                        ...
                        <div>
                          <img src="https://picsum.photos/180" alt="services" />
                        </div>
                      </div>
                    </div>
                  </div>
